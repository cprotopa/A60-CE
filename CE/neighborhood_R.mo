...
model neighborhood_R
  ...
  IDEAS.Interfaces.Building building9(
    ...
    redeclare IDEAS.VentilationSystems.None
      ventilationSystem,
    redeclare CE.HeatingSystems.Boiler heatingSystem(QNom={5900,8800,0}))
  ...
  IDEAS.Interfaces.Building building11(
    ...
    redeclare CE.HeatingSystems.HeatPump heatingSystem(QNom={1200,1300,0}))
                                       annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={50,-30})));
  IDEAS.Interfaces.Building building16(
    ...
    redeclare CE.HeatingSystems.HeatPump heatingSystem(QNom={1700,1700,0}))
                                       annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={110,-30})));
  IDEAS.Interfaces.Building building18(
    ...
    redeclare IDEAS.VentilationSystems.None
      ventilationSystem,
    redeclare CE.HeatingSystems.Boiler heatingSystem(QNom={1700,1700,0}))
  ...
  IDEAS.Interfaces.Building building20(
    ...
    redeclare IDEAS.VentilationSystems.None
      ventilationSystem,
    redeclare CE.HeatingSystems.Boiler heatingSystem(QNom={5700,6200,0}))
  ...
  IDEAS.Interfaces.Building building24(
    ...
    redeclare IDEAS.VentilationSystems.None
      ventilationSystem,
    redeclare CE.HeatingSystems.Boiler heatingSystem(QNom={6000,7000,0}))
